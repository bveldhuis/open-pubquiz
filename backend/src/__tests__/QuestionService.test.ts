...
describe('QuestionService', () => {
  ...
  describe('deleteQuestion', () => {
    it('should delete question successfully', async () => {
      ...
      mockQuestionRepository.findOne.mockResolvedValue(mockQuestion as Question);
      mockQuestionRepository.remove.mockResolvedValue(mockQuestion as Question);
      ...
      expect(mockQuestionRepository.remove).toHaveBeenCalledWith(mockQuestion);
    });
    ...
    it('should throw error when question not found for deletion', async () => {
      ...
      await expect(questionService.deleteQuestion(questionId))
        .rejects.toThrow('Question not found');

      expect(mockQuestionRepository.remove).not.toHaveBeenCalled();
    });
  });
  ...
  describe('bulkCreateQuestions', () => {
    it('should create multiple questions successfully', async () => {
      ...
      mockSessionService.getSessionByCodeOrThrow.mockResolvedValue(mockSession as QuizSession);
             mockQuestionRepository.save.mockResolvedValue(mockCreatedQuestions as Question[]);
